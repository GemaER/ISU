...
Partial Class frmGenealogia
    ...
    Private Sub InitializeComponent()
        ...
        Me.Controls.Add(Me.gbxHH)
        Me.Controls.Add(Me.gbxH)
        Me.Controls.Add(Me.gbxHM)
        Me.Controls.Add(Me.gbxMM)
        Me.Controls.Add(Me.gbxMH)
        Me.Controls.Add(Me.Panel1)
        Me.Name = "frmGenealogia"
        Me.Text = "Genealogia"
        Me.gbxMH.ResumeLayout(False)
        Me.gbxMH.PerformLayout()
        Me.gbxMM.ResumeLayout(False)
        Me.gbxMM.PerformLayout()
        Me.gbxHM.ResumeLayout(False)
        Me.gbxHM.PerformLayout()
        Me.gbxHH.ResumeLayout(False)
        Me.gbxHH.PerformLayout()
        Me.gbxM.ResumeLayout(False)
        Me.gbxM.PerformLayout()
        Me.gbxH.ResumeLayout(False)
        Me.gbxH.PerformLayout()
        Me.gbxY.ResumeLayout(False)
        Me.gbxY.PerformLayout()
